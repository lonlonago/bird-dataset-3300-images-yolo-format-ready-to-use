# Bird dataset (3300 images YOLO format ready to use

# Body

Bird dataset, 3300 images in YOLO format, ready-to-use, clear images, complete annotations, suitable for target detection, algorithm testing and other scenarios.
